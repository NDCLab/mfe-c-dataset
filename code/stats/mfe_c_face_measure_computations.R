...
input_organized_path <- paste(proje_wd, "derivatives", "psychopy", "csv_output", "mfe-c-face", sep ="/", collapse = NULL) # input directory for data files generated by the organizer script!
output_path <- paste(proje_wd, "derivatives", "psychopy", "stat_output", "mfe-c-face", sep ="/", collapse = NULL) # output directory
proc_fileName <- "processed_data_mfe_c_face_Proj_v1.csv" # output filename
...
main_df <- setNames(data.frame(matrix(ncol = 41, nrow = 0)), c("participant_id", "congAcc", "incongAcc",
                                                               ...
                                                               "correct_proRec", "num_incong_correctFaces_reported_new", "num_incong_correctFaces_reported_old",
    ...
    if (mean(as.numeric(flanker_df$current_trial_accuracy)) >= 0.6){
      ...
      if (nrow(legit_error_incong_flankerDat) >= 8 ){
        ...
        if (num_incong_error_faces_in_surp >= 8){
          ...
          overall_proRec <- (hit_num) / ((hit_num) + miss_num) # proRec = proportion recognized
...
redcapDat <- read.csv(file = "/Github_Repos/mfe-c-face-dataset/derivatives/redcap/Memoryforerrorcface_SCRD_2024-06-13_1453.csv")
...
redcapDat <- redcapDat[c("record_id", "demo_c_yob_s1_r1_e1", "scaared_b_scrdSoc_s1_r1_e1", "scaared_b_scrdGA_s1_r1_e1", "scaared_b_scrdTotal_s1_r1_e1",
                         "bfne_b_scrdTotal_s1_r1_e1", "epepq15_scrdTotal_s1_r1_e1", "phq8_scrdTotal_s1_r1_e1", "demo_c_gender_s1_r1_e1")]
