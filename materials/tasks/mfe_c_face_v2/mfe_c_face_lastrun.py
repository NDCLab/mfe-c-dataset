...
expName = 'mfe_c_face'  # from the Builder filename that created this script
expInfo = {
    'id': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kihossei/Library/CloudStorage/GoogleDrive-hosseinikianoosh@gmail.com/My Drive/My Digital Life/Professional/Github_Repos/mfe-c-face-dataset/materials/tasks/mfe_c_face_v2/mfe_c_face_lastrun.py',
